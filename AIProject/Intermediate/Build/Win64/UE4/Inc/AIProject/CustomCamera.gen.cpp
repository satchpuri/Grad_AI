...
// Cross Module References
	AIPROJECT_API UClass* Z_Construct_UClass_ACustomCamera_NoRegister();
	AIPROJECT_API UClass* Z_Construct_UClass_ACustomCamera();
...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_ACustomCamera()
	{
		...
		if (!OuterClass)
		{
			...
			static const UE4CodeGen_Private::FMetaDataPairParam Class_MetaDataParams[] = {
				{ "IncludePath", "CustomCamera.h" },
				{ "ModuleRelativePath", "Public/CustomCamera.h" },
			};
#endif
	...
	IMPLEMENT_CLASS(ACustomCamera, 1805713444);
	static FCompiledInDefer Z_CompiledInDefer_UClass_ACustomCamera(Z_Construct_UClass_ACustomCamera, &ACustomCamera::StaticClass, TEXT("/Script/AIProject"), TEXT("ACustomCamera"), false, nullptr, nullptr, nullptr);
