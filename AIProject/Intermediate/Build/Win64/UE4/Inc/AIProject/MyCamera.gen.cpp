...
// Cross Module References
	AIPROJECT_API UClass* Z_Construct_UClass_AMyCamera_NoRegister();
	AIPROJECT_API UClass* Z_Construct_UClass_AMyCamera();
...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_AMyCamera()
	{
		...
		if (!OuterClass)
		{
			...
			static const UE4CodeGen_Private::FMetaDataPairParam Class_MetaDataParams[] = {
				...
				{ "ModuleRelativePath", "Public/MyCamera.h" },
			};
#endif
	...
	IMPLEMENT_CLASS(AMyCamera, 1254449548);
	static FCompiledInDefer Z_CompiledInDefer_UClass_AMyCamera(Z_Construct_UClass_AMyCamera, &AMyCamera::StaticClass, TEXT("/Script/AIProject"), TEXT("AMyCamera"), false, nullptr, nullptr, nullptr);
